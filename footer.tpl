...
<!--▼FOOTER-->
        ...
        <div id="pagetop" class="navbar-fixed-bottom text-right btn-lg"><a href="#top" class="btn btn-primary" alt="このページの先頭へ"><span class="glyphicon glyphicon-arrow-up"></span></a></div>
        <hr />
