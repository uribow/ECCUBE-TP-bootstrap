...
<div class="frame_outer">
    ...
    <!--{if $arrPageLayout.HeaderTopNavi|@count > 0}-->
        <div id="headertopcolumn" class="col-md-3 col-sm-12">
            <!--{* ▼上ナビ *}-->
    ...
    <div id="container" class="clearfix">
        ...
        <!--{if $arrPageLayout.TopNavi|@count > 0}-->
            <div id="topcolumn" class="col-md-3 col-sm-12">
                <!--{* ▼上ナビ *}-->
        ...
        <!--{if $arrPageLayout.LeftNavi|@count > 0}-->
            <div id="leftcolumn" class="side_column col-md-3 col-sm-12">
                <!--{* ▼左ナビ *}-->
        ...
        <div 
            <!--{if $tpl_column_num == 3}-->
                id="three_maincolumn" class="col-md-6 col-sm-12"
            <!--{elseif $tpl_column_num == 2}-->
                <!--{if $arrPageLayout.LeftNavi|@count == 0}-->
                    id="two_maincolumn_left" class="col-md-9 col-sm-12"
                <!--{else}-->
                    id="two_maincolumn_right" class="col-md-9 col-sm-12"
                <!--{/if}-->
        ...
        <!--{if $arrPageLayout.RightNavi|@count > 0}-->
            <div id="rightcolumn" class="side_column col-md-3 col-sm-12">
                <!--{* ▼右ナビ *}-->
        ...
        <!--{if $arrPageLayout.BottomNavi|@count > 0}-->
            <div id="bottomcolumn" class="col-md-12 col-sm-12">
                <!--{* ▼下ナビ *}-->
